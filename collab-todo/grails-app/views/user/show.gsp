	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="categories-label" class="property-label"><g:message code="user.categories.label" default="Categories" /></span>
				...
				<g:if test="${userInstance?.todos}">
				<li class="fieldcontain">
					<span id="todos-label" class="property-label"><g:message code="user.todos.label" default="Todos" /></span>
